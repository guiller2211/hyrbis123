...
public class SeleniumHelper {
	...
	public static boolean canLoginToHybrisCommerce()  {		
		try {
			 if (VersionHelper.getVersion().equals(Version.V2005)|| VersionHelper.getVersion().equals(Version.V2011)) {	
				 	waitForConnectionToOpen("https://localhost:9002/login", PAUSE_FOR_SERVER_START_MS);
				 	getDriver().get("https://localhost:9002/login");		 
			 }
			 else {
